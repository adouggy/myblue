			...
			while (cur.moveToNext()) {
				...
				if (Integer.parseInt(cur.getString(cur.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))) > 0) {
					...
					while (emailCur.moveToNext()) {
						...
						CharSequence CustomemailType = ContactsContract.CommonDataKinds.Email.getTypeLabel(mContext.getResources(),
								type,
								customLabel);
					...
					while (addrCur.moveToNext()) {
						...
						System.out.println( poBox + "/" + street + "/" + city + "..." );
					}
					addrCur.close();
					...
					if (imCur.moveToFirst()) {
						...
						System.out.println( "instant message:" + imName + "/" + imType );
					}
					imCur.close();
					...
					if (orgCur.moveToFirst()) {
						...
						System.out.println( "Org name:" + orgName + "/" + title );
					}
					orgCur.close();
