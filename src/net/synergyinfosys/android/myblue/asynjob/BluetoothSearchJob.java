...
public class BluetoothSearchJob extends AsyncTask<String/*BLE or notBLE*/, Integer, String/*return nothing actually*/> {
	...
	protected String doInBackground(
		...
		if( param[0].compareTo(TYPE_BLE) == 0 ){
			...
			BluetoothAdapter.getDefaultAdapter().startDiscovery(); // take 12 seconds.
		}
